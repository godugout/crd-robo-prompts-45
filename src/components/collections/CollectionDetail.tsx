...
import { useCollection, useCollectionCards, useCollectionAnalytics } from '@/hooks/collections/useCollectionQueries';
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="activity" className="mt-6">
          <CollectionActivity collectionId={collectionId} />
        </TabsContent>
