...
import type { VisualEffectConfig } from '../hooks/useEnhancedCardEffects';

export const METALLIC_EFFECTS: VisualEffectConfig[] = [
  {
    id: 'foilspray',
    name: 'Foil Spray',
...
export const PRISMATIC_EFFECTS: VisualEffectConfig[] = [
  {
    id: 'holographic',
    name: 'Holographic',
...
export const SURFACE_EFFECTS: VisualEffectConfig[] = [
  {
    id: 'interference',
    name: 'Interference',
...
export const VINTAGE_EFFECTS: VisualEffectConfig[] = [
  {
    id: 'vintage',
    name: 'Vintage',
