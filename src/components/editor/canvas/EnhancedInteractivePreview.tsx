      ...
      >
        ...
        {selectedTemplate.id === 'sports-modern' && (
          <>
            ...
            >
              <span>{cardEditor?.cardData.series || 'TEAM'}</span>
        ...
        {selectedTemplate.id === 'school-academic' && (
          <>
            ...
            <div 
              className="absolute p-2 text-xs text-center"
              style={{
                left: regions.achievement.x * scaleFactor,
                top: regions.achievement.y * scaleFactor,
                width: regions.achievement.width * scaleFactor,
                height: regions.achievement.height * scaleFactor,
                backgroundColor: colors.secondary,
                color: colors.text
              }}
            >
        ...
        {/* Corporate Template */}
        {selectedTemplate.id === 'organization-corporate' && (
          <>
            <div 
              className="absolute flex items-center justify-center text-white font-bold text-sm"
              style={{
            ...
            >
              {photoUrl ? (
                ...
                <div 
                  className="w-full h-full bg-gray-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center cursor-pointer"
                  onClick={handlePhotoUpload}
                >
                  <Camera className="w-6 h-6 text-gray-400" />
                </div>
        ...
        {/* Social Template */}
        {selectedTemplate.id === 'friends-social' && (
          <>
            <div 
            ...
            <div 
              className="absolute overflow-hidden rounded-lg border-2"
              style={{
                left: regions.image.x * scaleFactor,
                top: regions.image.y * scaleFactor,
                width: regions.image.width * scaleFactor,
            ...
            >
              {photoUrl ? (
                ...
                <div 
                  className="w-full h-full bg-pink-50 border-2 border-dashed border-pink-300 flex flex-col items-center justify-center cursor-pointer"
                  onClick={handlePhotoUpload}
                >
        ...
        {/* Vintage Template */}
        {selectedTemplate.id === 'vintage-retro' && (
          <>
            <div 
              className="absolute flex items-center justify-center font-bold text-sm border-2"
              style={{
                left: regions.title.x * scaleFactor,
                top: regions.title.y * scaleFactor,
                width: regions.title.width * scaleFactor,
            ...
            <div 
              className="absolute border-4 border-double overflow-hidden"
              style={{
                left: regions.image.x * scaleFactor,
                top: regions.image.y * scaleFactor,
                width: regions.image.width * scaleFactor,
            ...
            >
              {photoUrl ? (
                ...
                <div 
                  className="w-full h-full bg-amber-50 flex items-center justify-center cursor-pointer"
                  onClick={handlePhotoUpload}
                >
