      ...
      <div className="bg-editor-dark/50 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-xl font-bold text-white">Bulk Card Upload Lab</h1>
          ...
          <p className="text-crd-lightGray text-sm mt-2 max-w-2xl">
            Experimental bulk upload with enhanced AI detection and batch processing capabilities.
          </p>
        </div>
      </div>
